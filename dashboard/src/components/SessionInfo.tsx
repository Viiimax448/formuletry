	...
	return (
		<div className="flex items-center gap-2">
			<Flag
				...
				className="h-9 w-14 rounded-md shadow-sm border border-neutral-700/50 shrink-0"
			/>

			<div className="flex flex-col justify-center">
				{session ? (
					<h1 className="truncate text-sm leading-none font-medium text-white font-sans">
				...
				{timeRemaining !== undefined ? (
					<p className="text-2xl leading-none font-extrabold font-mono">{timeRemaining}</p>
				) : (
