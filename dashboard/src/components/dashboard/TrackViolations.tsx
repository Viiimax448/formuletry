		...
		<div className="space-y-3">
			{violationDrivers && violationDrivers.length < 1 && (
				<div className="flex h-80 w-full flex-col items-center justify-center text-center">
					<div className="rounded-full bg-green-500/20 p-4 mb-3">
						<svg className="h-8 w-8 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
							<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
						</svg>
					</div>
					<p className="text-gray-400 font-medium">No violations yet</p>
					<p className="text-gray-500 text-sm mt-1">All drivers are within track limits</p>
				</div>
			)}
