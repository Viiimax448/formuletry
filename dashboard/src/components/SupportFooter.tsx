			...
			<div className="mx-auto max-w-7xl px-6">
				<div className="flex flex-col items-center justify-center gap-4 text-center">
					...
					<button
						...
						className="flex items-center gap-2 rounded-lg border border-pink-500/30 bg-pink-500/10 px-4 py-2 font-medium text-pink-400 transition-all duration-200 hover:border-pink-400 hover:bg-pink-500/20 hover:text-pink-300 hover:scale-105"
					>
